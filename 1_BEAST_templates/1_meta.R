...
names(getPalette) <- c("CENTRAL-CORRIDOR-AF", "CENTRAL-AF", "CENTRAL-PK", "EAST-PK", "CENTRAL-CORRIDOR-PK", "GB", "KARACHI", "KP", "NORTH-AF", "NORTH-CORRIDOR-AF", "NORTH-CORRIDOR-PK", "SINDH", "SOUTH-CORRIDOR-AF", "SOUTH-CORRIDOR-PK", "SOUTH-PUNJAB", "WEST-AF")

...
make_starting_trees(tree, treeoutfn = paste0("./all_",latestdate,"/startTrees.nwk"), ncpu =8, ntres = 8)
...
tree_afp <- read.tree(paste0(fn_afp, ".treefile"))

make_starting_trees(tree_afp, treeoutfn = paste0("./AFP_",latestdate,"/startTrees.nwk"), ncpu =8, ntres = 8)

...
tree <- read.beast("./AFP_only/AFP_PkAf_20230810/MJ_MCC_CA.trees")
tre  <- read.nexus("./AFP_only/AFP_PkAf_20230810/MJ_MCC_CA.trees")
...
low_season <- data.frame(Start = as.Date(c("2012-01-01", "2015-01-01")), End =  as.Date(c("2012-08-27", "2015-02-05")))
...
downstreamtree$detectdiff <- as.numeric(downstreamtree$detection-downstreamtree$V3)
t.test(downstreamtree$detectdiff)
